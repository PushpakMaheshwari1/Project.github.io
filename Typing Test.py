...
class Game:
    ...
    def __init__(self):
        ...
        pygame.init()
        self.open_img = pygame.image.load('images/screen-0.webp')
        self.open_img = pygame.transform.scale(self.open_img, (self.w, self.h))

        self.bg = pygame.image.load('images/wp3405510.jpg')
    ...
    def show_results(self, screen):
        if(not self.end):
            ...
            # draw icon image
            self.time_img = pygame.image.load('images/wp3405510.jpg')
